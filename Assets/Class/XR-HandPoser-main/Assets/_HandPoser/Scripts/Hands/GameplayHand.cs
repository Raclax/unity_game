...
public class GameplayHand : BaseHand
{
    ...
    private void TryApplyObjectPose(UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable interactable)
    {
        // Try and get pose container, and apply
    }

    private void TryApplyDefaultPose(UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable interactable)
    {
        // Try and get pose container, and apply
    }
